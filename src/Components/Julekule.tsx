...
import { StengtLuketekst } from './Luke';
...
const JulekuleStyle = styled.div<{nummer: number}>`
    ...
    background-color: ${props => farger[getRandomFromArray(farger.length)]};
    background-image: radial-gradient(circle at right bottom,rgba(0,0,0,.5),rgba(0,0,0,0));
    border-radius: 50%;
    box-shadow: inset .3em .3em 1em rgba(255,255,255,.5);
