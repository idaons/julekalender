...
const Dødmann = () => {
  return(
      <>
        <h3>Din yogaøvelse: Dødmannstilling <Emoji ariaLabel="zombie-emoji" content="🧟"/></h3>
        <p>Denne stillingen er ypperlig for å finne roen og bekjempe stress.
          Du bør ligge i dødmannsstillingen minimum 5 minutter for å få tilstrekkelig effekt. <br/>
          Legg deg forsiktig ned på ryggen på en matte med føttene spredd.
          La armene ligge langs gulvet, litt ut fra kroppen og med håndflatene pekende opp.
          Pust dypt og rolig. Kjenn at hele kroppen nærmest synker ned i bakken.
...
const Barn = () => {
  return (
    <>
      <h3>Din yogaøvelse: Barnet <Emoji ariaLabel="baby-emoji" content="👶"/></h3>
      <p>Sitt på hælene dine.
        Nnærne skal være omtrent like bredt plassert som hoftebredden din.
        Føttene skal være samlet, slik at storetærne berører hverandre. <br/>
...
const Luke11 = () => {
  ...
  return (
    <LukeInnhold nummer={11}>
      <Tekst>
        <h2>Finn din yoga-posisjon! <Emoji ariaLabel="lotus-emoji" content="🧘"/>
        </h2>
