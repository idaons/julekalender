import { Emoji, Tekst } from "~/src/Components/LukeInnhold";
import * as React from "react";
import { useState } from "react";
import styles from "~/src/Innhold/spesialInnhold/yoga.module.css";
  ...
  return (
    <Tekst>
      ...
      <div className={styles.selectWrapper}>
        <select className={styles.select} onChange={onYogaSelcted}>
