  ...
  return (
    <LukeInnhold nummer={23}>
      <Tekst>
        ...
        <p>
          Dagen før dagen - nå må du øve:
          <br />
          Still deg i knebøy position og hold stillingen mens du går rundt juletreet (eventuelt kontorstolen).{" "}
        </p>
        <p>
          Syng <Emoji ariaLabel="note-emoji" content="🎵" /> Så går vi rundt om en enebærbusk
          <Emoji ariaLabel="note-emoji" content="🎵" />, og ta et spensthopp hver gang du sier "busk".
        </p>
