...
const Kobra = () => {
  return (
    <>
      <h3>Din yogaøvelse: Kobra <Emoji ariaLabel="snake-emoji" content="🐍"/></h3>
      <p>
        Ligg på magen med strake, samlede bein og med hendene foran brystet.
        Pust inn, mens du langsomt løfter hodet og skyter fram brystet.
        Det er ryggen som skal bære kroppen.
...
const Hund = () => {
  return (
    <>
      <h3>Din yogaøvelse: Hunden som ser ned <Emoji ariaLabel="dog-emoji" content="🐶"/> </h3>
      <p>
      Ligg på knærne med hendene i gulvet i en skulderbreddes avstand.
...
const Kamel = () => {
  return(
    <>
      <h3>Din yogaøvelse: Kamelen <Emoji ariaLabel="kamel-emoji" content="🐫"/></h3>
      <p>
        ...
        Hold stillingen i 4–8 pust før du går forsiktig tilbake til utgangspunktet.
      </p>
    </>
  )
}
...
const Gresshoppe = () => {
  return (
    <>
      <h3>Din yogaøvelse: Gresshoppa <Emoji ariaLabel="cricket-emoji" content="🦗"/></h3>
      <p>
